...
def plot_boxplot_with_target_lines(data, correct_answers, output_path):
    # Wykres pudełkowy
    data.boxplot(column="bestCost", by="populationSize", grid=True, showmeans=True)
    ...
    # Opis osi i tytułów
    plt.title("Wykres pudełkowy: Wartość najkrótszej ścieżki z linią docelową i ekstremalnymi wartościami")
    plt.suptitle("")
...
def main():
    ...
    if data is not None:
        ...
        output_path = "boxplot_with_target_lines.png"
