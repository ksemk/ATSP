...
def plot_boxplot_with_target_lines(data, correct_answers, output_path):
    ...
    # Opis osi i tytułów
    plt.title("Wykres pudełkowy: Wartość najkrótszej ścieżki z analizą współczynnika mutation rate")
    plt.suptitle("")
...
def main():
    ...
    if data is not None:
        ...
        output_path = "boxplot_with_target_lines_mut.png"
